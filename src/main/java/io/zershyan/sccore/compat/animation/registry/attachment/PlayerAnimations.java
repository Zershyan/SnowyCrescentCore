...
public record PlayerAnimations(RideAnim rideAnim, HashMap<ResourceLocation, ResourceLocation> clientAnimMap,
                               HashMap<ResourceLocation, ResourceLocation> serverAnimMap) {
